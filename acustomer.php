...
<div class="container-fluid myclass" style="padding:0px; margin:0px;">
        <!--Navbar-->
        <nav class="navbar navbar-expand-sm  navbar-toggler navbar-light" style="background-color:#d7e7f9; opacity:1;"> 
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo02" style="float:right;">
                ...
                <li class="nav-item">
                        <a class="nav-link " href="index.php" style="color:#103d72;font-weight:1em;">
                            <div style="padding-right:0px;" >
                                
                            </div>
                            <span style="font-size:20px; padding-right:20px;" >&nbsp;&nbsp;Home</span>
                        </a> 
                    </li> 
                    <li class="nav-item">
                        <a class="nav-link" href="viewcustomers.php" style="font-size:20px; color:#103d72;font-weight:1em;">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="transferrecords.php" style="font-size:20px; color:#103d72;font-weight:1em;">
                            <div style="padding-left:20px;" >
...
<div class="row">
    ...
    <div style="padding-top:2%;display:inline;"><h4 class="font-weight-bold" style="color:#103d72;font-size:2em;;display:inline;margin:10px 5px 0px 5px;padding-top:1%">Customer Details</h4>
    </div>
        <br><br>
    ...
    <div class="col-sm" style="padding:1% 3%;">
        <div >
                    ...
                    <span class="font-weight-bold" style="color:#103d72;font-size:1.8em;line-height:1em;display:inline;margin:10px 5px 0px 5px;padding-top:1%">Money Transfer</span>
                    </div><br><br>
